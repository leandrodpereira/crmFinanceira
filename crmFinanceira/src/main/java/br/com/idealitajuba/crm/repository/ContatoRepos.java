...
public class ContatoRepos implements Serializable {
	...
	/**
	 * Método que verfica se existem agendamentos associados a um
	 * Contato. Útil para verificar antes de exlcuir . 
	 * @param id
	 * @return true se a lista estiver vazia.
	 * @author Leandro Duarte
	 */
	public boolean verificaAgendamento(Long id) {
		TypedQuery<Agendamento> query = this.em.createQuery("from Agendamento a where a.contato.id=" + id, Agendamento.class);
